...
- เลือกชื่อผู้เบิกจากรายชื่อที่เรียงตามตัวอักษรภาษาไทย
- บันทึกชื่อลูกค้า แหล่งที่มา หมายเลขเครื่อง และกำหนดคืน
...
หากมีแท็บ `Transactions` จากรุ่นก่อน ระบบจะเพิ่มคอลัมน์ `Customer Name` ที่ท้ายตารางให้อัตโนมัติ โดยไม่ย้ายหรือลบข้อมูลเดิม
